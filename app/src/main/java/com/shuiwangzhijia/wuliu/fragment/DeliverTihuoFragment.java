...
@BaseViewInject(contentViewId = R.layout.fragment_deliver_tihuo)
public class DeliverTihuoFragment extends BaseLazyFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getData() {
        showLoadingDialog();
        RetrofitUtils.getInstances().create().getOutOrderDetail(0).enqueue(new Callback<EntityObject<OutOrderDetailBean>>() {

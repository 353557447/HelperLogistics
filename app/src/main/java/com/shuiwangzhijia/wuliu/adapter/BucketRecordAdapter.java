...
public class BucketRecordAdapter extends RecyclerView.Adapter<BucketRecordAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.date.setText(DateUtils.getFormatDateStr(item.getOrder_time() * 1000));
        ...
        holder.depositTv.setText("押金总金额：" + item.getTotal_price() + "元");
        holder.totalNumTv.setText("共计：" + item.getSum() + "个桶");
    }

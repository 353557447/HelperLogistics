 ...
 *
 */
public class OrderItemAdapterNew extends RecyclerView.Adapter<OrderItemAdapterNew.ViewHolder> {
    ...
    public OrderItemAdapterNew(Context context, boolean isOrderList) {
        mContext = context;

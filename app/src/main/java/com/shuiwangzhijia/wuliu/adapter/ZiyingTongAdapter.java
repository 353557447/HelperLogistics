...
/**
 * 添加自营桶适配器
 * created by xxc on 2018/8/17.
 */
public class ZiyingTongAdapter extends RecyclerView.Adapter<ZiyingTongAdapter.ViewHolder> {
    ...
    public ZiyingTongAdapter(Context context, boolean fromHandler) {
        mContext = context;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(item instanceof BucketBean){
            holder.name.setText(((BucketBean) item).getGname() );

...
public class DeliverOrderAdapter extends RecyclerView.Adapter<DeliverOrderAdapter.ViewHolder> {
    ...
    private final List<OutOrderDetailBean.GoodsBean> mData;


    public DeliverOrderAdapter(Context context, List<OutOrderDetailBean.GoodsBean> goods) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_deliver_order, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mItemPendingNumber.setText("(x"+mData.get(position).getNum()+")");
    }

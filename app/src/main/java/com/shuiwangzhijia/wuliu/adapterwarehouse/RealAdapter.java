...
public class RealAdapter extends RecyclerView.Adapter<RealAdapter.ViewHolder> {
    ...
    public RealAdapter(Context context, List<OrderDetailBean.ActualBean> actual) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_warehouse_handle_order, parent, false);

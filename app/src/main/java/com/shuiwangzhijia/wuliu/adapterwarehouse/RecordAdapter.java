...
import com.shuiwangzhijia.wuliu.beanwarehouse.RecordBean;
...
public class RecordAdapter extends RecyclerView.Adapter<RecordAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_warehouse_record, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        switch (type) {
            ...
            case 5:
                holder.llInfo.setVisibility(View.GONE);
                holder.count.setText("" + item.getZ_num());
                break;
        }

...
public class ZiyingAdapter extends RecyclerView.Adapter<ZiyingAdapter.ViewHolder> {
    ...
    public ZiyingAdapter(Context context, List<WarehouseGoodsBean> refund) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_warehouse_tuishui_number, parent, false);

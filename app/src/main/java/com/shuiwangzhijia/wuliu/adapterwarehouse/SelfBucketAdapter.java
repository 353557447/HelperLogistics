...
public class SelfBucketAdapter extends RecyclerView.Adapter<SelfBucketAdapter.ViewHolder> {
    ...
    public List<WarehouseGoodsBean> getGoodsData() {
        return goodsData;
    }

    public void setGoodsData(List<WarehouseGoodsBean> goodsData) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if(item instanceof WarehouseGoodsBean){
            holder.name.setText(((WarehouseGoodsBean) item).getGname() );
            holder.check.setSelected(((WarehouseGoodsBean) item).isCheck());
        }
    }

...
import com.shuiwangzhijia.wuliu.adapter.TianjiaShuipiaoAdapter;
 ...
 */
public class AddZatongDialog extends Dialog {
    ...
    TextView sureBtn;
    private List<CanShuipiaoBean> selectData = new ArrayList<>();
    private String data;
     ...
     * @param context 上下文
     */
    public AddZatongDialog(Context context, List<CanShuipiaoBean> data, final OnConfirmClickListener listener) {
        ...
        mAdapter = new TianjiaShuipiaoAdapter(context,false);
        mAdapter.setBucketData(data);
        mAdapter.setOnItemClickListener(new TianjiaShuipiaoAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                if (item instanceof CanShuipiaoBean)
                    ((CanShuipiaoBean) item).setCheck(!((CanShuipiaoBean) item).isCheck());
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.cancelBtn:
                ...
                break;
            case R.id.sureBtn:
                List<CanShuipiaoBean> data = mAdapter.getBucketData();
                if (data != null){
...
//                        bean.setCount(count > 0 ? count : 1);
    ...
    public interface OnConfirmClickListener {
        void onConfirm(Dialog dialog, List<CanShuipiaoBean> data);
    }

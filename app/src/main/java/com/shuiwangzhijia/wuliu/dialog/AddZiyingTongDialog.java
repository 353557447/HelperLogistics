...
import com.shuiwangzhijia.wuliu.adapter.ZiyingTongAdapter;
...
/**
 * 自营桶弹窗
 * Created by xxc on 2017/5/23.
 */
public class AddZiyingTongDialog extends Dialog {

    private final ZiyingTongAdapter mSelfBucketAdapter;
     ...
     * @param context 上下文
     */
    public AddZiyingTongDialog(Context context, List<BucketBean> data, final OnConfirmClickListener listener) {
        ...
        mSelfBucketAdapter = new ZiyingTongAdapter(context, false);
        mSelfBucketAdapter.setBucketData(data);
        mSelfBucketAdapter.setOnItemClickListener(new ZiyingTongAdapter.OnRecyclerViewItemClickListener() {

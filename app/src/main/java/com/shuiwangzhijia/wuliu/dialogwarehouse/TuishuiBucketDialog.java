 ...
 */
public class TuishuiBucketDialog extends Dialog {
    ...
    TextView sureBtn;
    private List<WarehouseGoodsBean> selectData = new ArrayList<>();
     ...
     * @param context 上下文
     */
    public TuishuiBucketDialog(Context context, List<WarehouseGoodsBean> data, final OnConfirmClickListener listener) {
        ...
        mSelfBucketAdapter = new SelfBucketAdapter(context, true);
        mSelfBucketAdapter.setGoodsData(data);
        mSelfBucketAdapter.setOnItemClickListener(new SelfBucketAdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                if (item instanceof WarehouseGoodsBean)
                    ((WarehouseGoodsBean) item).setCheck(!((WarehouseGoodsBean) item).isCheck());
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.cancelBtn:
                ...
                break;
            case R.id.sureBtn:
                List<WarehouseGoodsBean> data = mSelfBucketAdapter.getGoodsData();
                if (data != null){
...
//                        bean.setCount(count > 0 ? count : 1);
    ...
    public interface OnConfirmClickListener {
        void onConfirm(Dialog dialog, List<WarehouseGoodsBean> data);
    }

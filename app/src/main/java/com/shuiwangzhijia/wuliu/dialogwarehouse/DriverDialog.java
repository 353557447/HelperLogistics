...
import com.shuiwangzhijia.wuliu.adapterwarehouse.DriverAdapter;
...
public class DriverDialog extends Dialog {
    ...
    private void getDriverList() {
        RetrofitUtils.getInstances().create().warehouseGetDriverList().enqueue(new Callback<EntityObject<ArrayList<WarehouseDriverBean>>>() {
            @Override
            public void onResponse(Call<EntityObject<ArrayList<WarehouseDriverBean>>> call, Response<EntityObject<ArrayList<WarehouseDriverBean>>> response) {
                EntityObject<ArrayList<WarehouseDriverBean>> body = response.body();
                if (body.getCode() == 200) {
            ...
            @Override
            public void onFailure(Call<EntityObject<ArrayList<WarehouseDriverBean>>> call, Throwable t) {

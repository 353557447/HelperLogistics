...
import com.shuiwangzhijia.wuliu.beanwarehouse.MainTabDb;
import com.shuiwangzhijia.wuliu.dialogwarehouse.NoticeDialog;
...
//        startLocation();
    ...
    private void initXGPush() {
        ...
        intentFilter.addAction("com.funengda.warehouse.Receiver");
   ...
   /* private void checkVersion() {
        RetrofitUtils.getInstances().create().getAppVersionInfo( 0, 3).enqueue(new Callback<EntityObject<UpdateInfo>>() {
            @Override
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                ...
                if (secondTime - firstTime > 2000) {
                    //如果两次按键时间间隔大于2秒，则不退出
                    ToastUitl.showToastCustom("再按一次退出水的快递-仓库端");

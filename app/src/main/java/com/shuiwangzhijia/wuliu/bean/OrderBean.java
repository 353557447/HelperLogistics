...
public class OrderBean implements Serializable {
    ...
    private List<BucketBean> recycler;//回桶

    public List<BucketBean> getRefundwt_water() {
        return refundwt_water;
    }

    public void setRefundwt_water(List<BucketBean> refundwt_water) {
        this.refundwt_water = refundwt_water;
    }

    public List<BucketBean> getReturn_water() {
        return return_water;
    }

    public void setReturn_water(List<BucketBean> return_water) {
        this.return_water = return_water;
    }

    private List<BucketBean> refundwt_water;//烂水
    private List<BucketBean> return_water;//退水
